...
<div class="comercios index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $comercio['Comercio']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $comercio['Comercio']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
